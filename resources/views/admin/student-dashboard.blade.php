                ...
                <div class="card flex-fill comman-shadow">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="card-title">Outbound Mobility Application</h5>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 d-flex align-items-center justify-content-center">
                                <div class="skip-group">
                                    <button type="submit" class="btn btn-info skip-btn">Update</button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="calendar-info calendar-info1">
                            <div class="up-come-header">
                                <h2>Upcoming Programmes (open)</h2>
                            ...
                            <div class="calendar-details">
                                ...
                                <div class="calendar-box normal-bg">
                                    <div class="calandar-event-name">
                                        <h4>Java Odyssey: Sharing, Training, and Beyond</h4>
                                        <h5>Dr. Lili Marziana Bt. Abdullah</h5>
                                    </div>
                                    <button type="submit" class="btn btn-info skip-btn">view</button>
                                </div>
                            </div>
                            <div class="calendar-details">
                                <p>17 July - 4 Aug</p>
