...
<head>
    ...
    <title>Admin Dashboard</title>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" href="{{ asset('html-template/assets/img/favicon.png') }}">

        <!-- Google Fonts -->
        <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,500;0,700;0,900;1,400;1,500;1,700&display=swap" rel="stylesheet">

        <!-- Bootstrap CSS -->
        <link rel="stylesheet" href="{{ asset('html-template/assets/plugins/bootstrap/css/bootstrap.min.css') }}">

        <!-- Feather Icons -->
        <link rel="stylesheet" href="{{ asset('html-template/assets/plugins/feather/feather.css') }}">

        <!-- Flags Icons -->
        <link rel="stylesheet" href="{{ asset('html-template/assets/plugins/icons/flags/flags.css') }}">

        <!-- FontAwesome -->
        <link rel="stylesheet" href="{{ asset('html-template/assets/plugins/fontawesome/css/fontawesome.min.css') }}">
        <link rel="stylesheet" href="{{ asset('html-template/assets/plugins/fontawesome/css/all.min.css') }}">

        <!-- Main CSS -->
        <link rel="stylesheet" href="{{ asset('html-template/assets/css/style.css') }}">
